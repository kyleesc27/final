...
def load_model():
    try:
        with open('pages/vegetables.p', 'rb') as f:
            model = pickle.load(f)
        return model
...
st.write("## 👨‍🌾 Vegetables Classification Model 🐓")
st.write(":smiley: Upload an image of a , and vegtables we'll predict its category based on our trained model! :smiley:")
st.write("it limit only in 🥔Potato, 🎃Pumpkin,🌱Radish, 🍅Tomato")
...
if my_upload is not None:
    ...
    st.write("This app is developed by Kyle Brian Escarilla.")
